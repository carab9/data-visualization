...
![alt text](https://github.com/carab9/data-visualization/architecture.png?raw=true)
...
![alt text](https://github.com/carab9/data-visualization/sealevel_co2_linreg.png?raw=true)


This barchart shows sea level rise vs CO2 levels. Each bar is one year.

![alt text](https://github.com/carab9/data-visualization/sealevel_co2_barchart.png)
